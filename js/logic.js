...
function paintforclick()
{
    ...
    for(let i = 0; i < lineal; i++) //ciclos do while(i < lineal) i = i + 1
    {
        yi = space * i;
        xf = space * (i + 1);
        yf = 222 - space * (i + 1)
...
var x = 150;
var y = 150;
drawLineall('blue', lienzoo, 149, 149, 151, 151);
drawLineall('black', lienzoo, 1, 1, 1, 299);
drawLineall('black', lienzoo, 1, 299, 299, 299);
drawLineall('black', lienzoo, 299, 1, 299, 299);
drawLineall('black', lienzoo, 1, 1, 299, 1);
